...
public class RestaurantOwnerGetMonthlyMenuPreferencesReportC extends HttpServlet {
	@Override
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        ArrayList<HashMap<String, Object>> reportArr = report.getMonthlyMenuPreferencesReport(year, month);
