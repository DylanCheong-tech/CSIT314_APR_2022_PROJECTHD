...
public class RestaurantOwnerGetDailyMenuPreferencesReportC extends HttpServlet {
	@Override
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        ArrayList<HashMap<String, Object>> reportArr = report.getDailyMenuPreferencesReport(year, month, day);
