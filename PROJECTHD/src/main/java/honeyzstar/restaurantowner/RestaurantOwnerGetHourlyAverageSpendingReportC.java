...
public class RestaurantOwnerGetHourlyAverageSpendingReportC extends HttpServlet {
	@Override
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        ArrayList<HashMap<String, Object>> reportArr = report.getHourlyAverageSpendingReport(year, month, day);
