...
public class RestaurantOwnerGetHourlyVisitFrequencyReportC extends HttpServlet {
	@Override
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        ArrayList<HashMap<String, Object>> reportArr = report.getHourlyVisitFrequencyReport(year, month, day);
