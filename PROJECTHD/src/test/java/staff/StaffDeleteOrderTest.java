...
import honeyzstar.staff.StaffDeleteOrderC;

public class StaffDeleteOrderTest {
    ...
    public void testDeleteOrder() throws ServletException, IOException {
        ...
        assertEquals("Create Order Successful Redirection", "/staff/staff-delete-order.html?status=success", args.getValue());
    }
